...
WVP_Chassis::WVP_Chassis(const std::string& name, bool fixed, CollisionType chassis_collision_type)
    ...
    utils::ChBodyGeometry::BoxShape box1(ChVector3d(0.0, 0.0, 0.1), ChQuaternion<>(1, 0, 0, 0), ChVector3d(2.0, 1.0, 0.2));
    utils::ChBodyGeometry::BoxShape box2(ChVector3d(0.0, 0.0, 0.3), ChQuaternion<>(1, 0, 0, 0), ChVector3d(1.0, 0.5, 0.2));

    m_geometry.vis_boxes.push_back(box1);
    m_geometry.vis_boxes.push_back(box2);

    m_geometry.vis_model_file = GetVehicleDataFile("wvp/WVP_Chassis.obj");
    ...
    switch (chassis_collision_type) {
        ...
        case CollisionType::HULLS: {
            utils::ChBodyGeometry::ConvexHullsShape hull("hmmwv/WVP_Chassis_simple.obj", 0);
