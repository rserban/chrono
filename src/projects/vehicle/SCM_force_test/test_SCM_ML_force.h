...
// Shu: add ML terrain
#include "chrono_vehicle/terrain/MLTerrain.h"
...
// const std::string SCM_filename_i = out_dir + "/SCM_forces.txt";
// const std::string SCM_filename_o = out_dir + "/SCM_forces_MLTerrain_wheelTotal.txt";
...
std::shared_ptr<vehicle::MLTerrain> CreateMLTerrain(double resolution, bool enable_bulldozing, ChSystem& sys, std::vector<std::shared_ptr<ChBodyAuxRef>>& wheels) {
    // auto terrain = chrono_types::make_shared<vehicle::MLTerrain>(&sys, wheels, SCM_filename_i, SCM_filename_o);
    // auto terrain = chrono_types::make_shared<vehicle::MLTerrain>(&sys, wheels, SCM_filename_i);
    auto terrain = chrono_types::make_shared<vehicle::MLTerrain>(&sys, wheels, SCM_filename);
    ...
    // Set some visualization parameters
    terrain->SetPlotType(vehicle::MLTerrain::PLOT_PRESSURE, 0, 20000);
    terrain->SetMeshWireframe(true);
