...
ChVector3d trackPoint(0.0, 3.0, 0.0);
...
int main(int argc, char* argv[]) {
    ...
    if (argc != 5) {
        std::cout << "usage: prog height_inch startSpeed_mph endSpeed_mph stepSpeed_mph\n";
        return 1;
    }
    ...
    std::cout << "ObsHeight       = " << obsHeightInch << " in\n";
    std::cout << "Speed at 2.5g   = " << resSpeed << " mph\n";
    std::cout << "Max. vert. Acc. = " << amax << " g\n";
    return 0;
}
